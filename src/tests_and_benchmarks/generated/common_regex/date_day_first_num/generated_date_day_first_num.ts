...
const fiber0042 = (
  ...
  // needs followUp & forkingFiber
  while (matches0 >= 0) {
    const directFollowUpResult0 = fiber0036(
      i,
      str,
      groupMarkers,
      tempGroupStartMarkers,
...
const fiber0060 = (
  ...
  // needs followUp & forkingFiber
  while (matches1 >= 0) {
    const directFollowUpResult1 = fiber0054(
      i,
      str,
      groupMarkers,
      tempGroupStartMarkers,
...
const fiber0061 = (
  ...
  while (true) {
    let wrappedResult = -1;
    const startinlineFiber0062 = i;
    inlineFiber0062: {
      let i = startinlineFiber0062;
