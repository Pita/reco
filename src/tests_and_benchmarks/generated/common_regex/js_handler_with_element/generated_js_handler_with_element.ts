...
const fiber0003 = (
   ...
   *              ^^^^^^^^^^^^^^^^^^^^^^^^^^
   */
  const lookaroundResult1 = fiber0004(
    i,
    str,
    groupMarkers,
    tempGroupStartMarkers,
...
const fiber0013 = (
  ...
  // needs followUp & forkingFiber
  while (matches2 >= 0) {
    const directFollowUpResult2 = fiber0011(
      i,
      str,
      groupMarkers,
      tempGroupStartMarkers,
...
const fiber0015 = (
  ...
  // needs followUp & forkingFiber
  while (matches4 >= 1) {
    const directFollowUpResult4 = fiber0013(
      i,
      str,
      groupMarkers,
      tempGroupStartMarkers,
