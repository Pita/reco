...
const fiber0071 = (
  ...
  while (true) {
    let wrappedResult = -1;
    const startinlineFiber0072 = i;
    inlineFiber0072: {
      let i = startinlineFiber0072;
...
const fiber0085 = (
  ...
  // needs followUp & forkingFiber
  while (matches1 >= 0) {
    const directFollowUpResult1 = fiber0079(
      i,
      str,
      groupMarkers,
      tempGroupStartMarkers,
...
const fiber0087 = (
  ...
  while (true) {
    let wrappedResult = -1;
    const startinlineFiber0088 = i;
    inlineFiber0088: {
      let i = startinlineFiber0088;
...
const fiber0114 = (
  ...
  while (true) {
    let wrappedResult = -1;
    const startinlineFiber0115 = i;
    inlineFiber0115: {
      let i = startinlineFiber0115;
