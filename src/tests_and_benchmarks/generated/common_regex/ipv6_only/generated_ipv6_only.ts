...
const fiber0002 = (i: number, str: string, context: Context): number => {
  ...
  /*
   * groupStartMarker
   * ...A-F]{0,3}:([0-9a-fA-F][0-9a-fA-F]{0,3}:)[0-9a-fA-F...
   *              ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
   */
  ...
  if (charCode14 <= 70) {
    if (charCode14 <= 57) {
      result14 = charCode14 >= 48;
    } else {
      result14 = charCode14 >= 65;
    }
  } else {
    if (charCode14 <= 102) {
      result14 = charCode14 >= 97;
    } else {
      result14 = false;
    }
  }
  ...
  if (charCode18 <= 70) {
    if (charCode18 <= 57) {
      result18 = charCode18 >= 48;
    } else {
      result18 = charCode18 >= 65;
    }
  } else {
    if (charCode18 <= 102) {
      result18 = charCode18 >= 97;
    } else {
      result18 = false;
    }
  }
