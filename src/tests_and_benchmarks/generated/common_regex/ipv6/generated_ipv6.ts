...
const fiber0069 = (
  ...
  // needs followUp & forkingFiber
  while (matches0 >= 0) {
    const directFollowUpResult0 = fiber0067(
      i,
      str,
      groupMarkers,
      tempGroupStartMarkers,
...
const fiber0079 = (
  ...
  // needs followUp & forkingFiber
  while (matches0 >= 0) {
    const directFollowUpResult0 = fiber0077(
      i,
      str,
      groupMarkers,
      tempGroupStartMarkers,
...
const fiber0089 = (
  ...
  // needs followUp & forkingFiber
  while (matches0 >= 0) {
    const directFollowUpResult0 = fiber0087(
      i,
      str,
      groupMarkers,
      tempGroupStartMarkers,
...
const fiber0115 = (
  ...
  // needs followUp & forkingFiber
  while (matches0 >= 0) {
    const directFollowUpResult0 = fiber0113(
      i,
      str,
      groupMarkers,
      tempGroupStartMarkers,
...
const fiber0125 = (
  ...
  // needs followUp & forkingFiber
  while (matches0 >= 0) {
    const directFollowUpResult0 = fiber0123(
      i,
      str,
      groupMarkers,
      tempGroupStartMarkers,
