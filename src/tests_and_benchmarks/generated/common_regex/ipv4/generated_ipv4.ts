...
// Regex optimized to: /^(?:[0-9]|[1-9][0-9]|1[0-9][0-9]|2(?:[0-4][0-9]|5[0-5]))\.(?:[0-9]|[1-9][0-9]|1|[0-4][0-9]|5[0-5])\.(([0-9]|[1-9][0-9]|1|[0-4][0-9]|5[0-5])\.)([0-9]|[1-9][0-9]|1[0-9][0-9]|2(?:[0-4][0-9]|5[0-5]))$/
...
export function generatedRegexMatcher(str: string) {
  ...
  for (let i = min; i <= max; i++) {
    const posAfterMatch = fiber0027(i, str, context);
    if (posAfterMatch !== -1) {
      return {
        index: i,
        matches: [
...
const fiber0001 = (i: number, str: string, context: Context): number => {
  /*
   * groupEndMarker
   * ...5[0-5])\.)([0-9]|[1-9][0-9]|1[0-9][0-9]|2(?:[0-4][0-9]|5[0-5]))$/
   *              ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
   */
...
const fiber0015 = (i: number, str: string, context: Context): number => {
  ...
  i++;
  return fiber0014(i, str, context);
};
...
const fiber0027 = (i: number, str: string, context: Context): number => {
  ...
  context.groupMarkerStart2 = groupMarkerStartCopy2;
  context.groupMarkerEnd2 = groupMarkerEndCopy2;
  const length1 = fiber0022(i, str, context);
  if (length1 !== -1) {
    return length1;
  }
  context.groupMarkerStart0 = groupMarkerStartCopy0;
  ...
  context.groupMarkerStart2 = groupMarkerStartCopy2;
  context.groupMarkerEnd2 = groupMarkerEndCopy2;
  const length2 = fiber0023(i, str, context);
  if (length2 !== -1) {
    return length2;
  }
  context.groupMarkerStart0 = groupMarkerStartCopy0;
  ...
  context.groupMarkerStart2 = groupMarkerStartCopy2;
  context.groupMarkerEnd2 = groupMarkerEndCopy2;
  const length3 = fiber0024(i, str, context);
  if (length3 !== -1) {
    return length3;
  }
  context.groupMarkerStart0 = groupMarkerStartCopy0;
